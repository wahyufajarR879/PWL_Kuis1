...
<head>
    ...
    <title>Daftarr Suplier - Blog Page</title>
<!--
Classic Template
        ...
        <div class="tm-header">
            <div class="container-fluid">
                <div class="tm-header-inner">
                    <a href="#" class="navbar-brand tm-site-name">Daftar Suplier</a>
                ...
                <div class="row">
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-8 col-lg-9 col-xl-9">
                        <div class="tm-blog-post">
                            <p>Berikut ini adalah daftar suplier yang diambil dari database</p>
                            <table border="1">
                                <caption>Daftar supplier</caption>
                                <thead>
                                    <tr>
                                        <th>id supplier</th>
                                        <th>nama supplier</th>
